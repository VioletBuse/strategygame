...
import ecs/entities/ships.{
  type Ship, OutpostTarget as ShipOutpostTarget, Player as ShipPlayerOwned,
  ShipTarget as ShipShipTarget, Unowned as ShipUnowned,
}
import ecs/entities/specialists.{
  type Specialist, OutpostLocation as SpecOutpostLocation,
  ShipLocation as SpecShipLocation, Specialist,
}
